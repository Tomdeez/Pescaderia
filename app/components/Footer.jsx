      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row md:justify-between md:items-start gap-10 md:gap-0">
          ...
          <ul className="flex flex-col md:flex-row gap-3 md:gap-6">
            {enlaces.map((enlace) => (
              ...
              >
                <a
                  href={enlace.href}
                  className="text-sky-800 hover:text-emerald-600 font-medium transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-400 px-1 py-0.5 rounded"
        ...
        <div className="flex-1 flex flex-col items-start md:items-end gap-2">
          <div className="flex items-center gap-2">
            ...
            <a href="https://wa.me/TU_NUMERO" target="_blank" rel="noopener noreferrer" className="text-sky-800 hover:text-emerald-600 font-medium transition-colors" aria-label="Contactar por WhatsApp">+54 9 336 123-4567</a>
          </div>
          <div className="flex items-center gap-2">
            {/* Teléfono */}
            ...
            <a href="tel:+543361234567" className="text-sky-800 hover:text-emerald-600 font-medium transition-colors" aria-label="Llamar por teléfono">(336) 123-4567</a>
          </div>
          <div className="flex items-center gap-2">
            {/* Email */}
            ...
            <a href="mailto:info@estrellitademar.com" className="text-sky-800 hover:text-emerald-600 font-medium transition-colors" aria-label="Enviar email">info@estrellitademar.com</a>
          </div>
        </div>
      </div>
