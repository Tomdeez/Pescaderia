        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off" noValidate>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              disabled={enviando}
              className={`w-full py-3 rounded-lg font-semibold text-lg transition-colors flex items-center justify-center gap-2 shadow-md focus-visible:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 ${
                enviando
          ...
          <div className="mt-8 text-center">
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-7 py-3 rounded-lg shadow-lg transition-colors text-lg focus-visible:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2"
